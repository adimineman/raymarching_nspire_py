...
camera = {"dir": [toRad(0), toRad(90)], "poz": [0, 0, 0], "fovX": toRad(360), "fovY": toRad(180), "back": lambda ray:mapC((255,255,255),(100,50,150),ray.dist/max_dist)}
objects = [
    [lambda ray:circle(ray.poz[0]-2, ((ray.poz[1]+1)%2)-1, ((ray.poz[2]+2)%4)-2, 1),
...
def __main__():
    ...
    for x in range(w):
        ...
        print(x)
        if x%500==0:g.save("render.png", "PNG")
